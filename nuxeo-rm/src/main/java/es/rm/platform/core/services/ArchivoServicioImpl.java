...
import es.rm.platform.api.services.FlujoTrabajoDescriptor;
...
import es.rm.platform.api.utils.UtilidadesQuartz;
...
public class ArchivoServicioImpl extends DefaultComponent implements
	 ...
	 */
	@Override
	public final void activate(final ComponentContext context) throws Exception {
		/*
