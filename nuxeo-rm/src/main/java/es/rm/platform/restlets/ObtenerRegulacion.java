...
/**
 * 
 * Restlet para obtener una entidad Regulacion del Modelo.
 * 
 */
@Name("obtenerRegulacion")
@Scope(EVENT)
public class ObtenerRegulacion extends ObtenerEntidadRestlet {

	/**
	 * Implementacion del restlet para obtener una Regulacion. No se declara
	 * como final debido a que en ese caso la inyecci&oacute;n de dependencias dejar&iacute;a
	 * de funcionar.
	 *  
	 * @param docId
	 *            Id del documento
	...
	public final DocumentModel extraerEntidad(String docId) throws Exception {
		...
		return servicio.obtenerRegulacion(getDocumentManager(), docId);
	}
