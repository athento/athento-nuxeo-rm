	...
	public static Map<String, Object> encuentraObjetoAsociado(
		...
		try {
			...
			if (calendario != null) {
				...
				Object ob = calendario.getProperty(ArchivoConstantes.CALENDARIO_CONSERVACION,
				...
				if (ob != null) {
					...
					if (objetosAsociados != null) {
						for (Map<String, Object> elemento : objetosAsociados) {
							String docId = (String) elemento.get(ArchivoConstantes.DOC_ID);
	...
	public static void actualizaObjetoAsociado(final CoreSession sesion,
		...
		try {
			...
			calendario.setProperty(ArchivoConstantes.CALENDARIO_CONSERVACION,
					ArchivoConstantes.OBJETOS_ASOCIADOS_CALENDARIO, nuevosObjetos);
